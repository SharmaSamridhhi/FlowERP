...
- Git read operation (log, diff, status, branch, show, blame, etc.).
-
...
Once all of the above pass, stop. Do not commit, push, do not open a PR, do not merge.give user a meaningful and valid commit message and Ask the user to commit, push and review the implementation.

From there:

- The user will commits, pushes the branch, opens the Pull Request, and merges it into `main`.
