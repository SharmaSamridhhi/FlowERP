...
**Excluded:**
- Actually provisioning secrets in a hosting provider's dashboard (FLO-020) — this spec defines *what* variables exist and how they're validated, not where production values are stored.
